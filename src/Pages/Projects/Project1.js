...
import img1 from '../../Images/bike1.png';
import img2 from '../../Images/bike2.png';
        ...
        <div>
            ...
            <Container>
                <Row>
                    ...
                    <a href="https://motor-bike-7b0ce.web.app/" target="_blank" rel="noreferrer noopener" > <Button className="btn btn-success m-2 px-3"> Live Link </Button> </a>
                    <a href="https://github.com/ihasanarnob/motor-bike-client" target="_blank" rel="noreferrer noopener" > <Button className="btn btn-primary m-2 px-3"> Client Side Github Link  </Button> </a>
                    <a href="https://github.com/ihasanarnob/motor-bike-server" target="_blank" rel="noreferrer noopener" > <Button className="btn btn-primary m-2 px-3"> Server Side Github Link  </Button> </a>
                </Row>
                <Row>
                    <Col xs={6} md={4}>
